...
public class HomePage extends Page {
  ...
  private static final By openNewAccountLink =
      By.linkText("Open New Account");
  private static final By accountsOverviewLink =
      By.linkText("Accounts Overview");
  private static final By transferFundsLink =
      By.linkText("Transfer Funds");
  private static final By logoutLink =
      By.linkText("Log Out");
